...
# Copy workspace package.json files to maintain structure for caching
...
# --- Runtime Stage ---
# Use a valid slim tag. If 'latest-slim' doesn't exist, we fallback to 'latest'
# or a known versioned slim tag. oven/bun:1-slim is usually reliable.
...
# Copy built artifacts and source for running (monorepo usually needs source for bun run)
